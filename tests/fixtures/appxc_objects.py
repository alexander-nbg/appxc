...
"""Helper functions to generate dummy APPXC objects for testing"""

import os

from appxc.config import Config
from appxc.registry import Registry
from appxc.security import Security
from appxc.storage import LocalStorage, RamStorage, Storage
