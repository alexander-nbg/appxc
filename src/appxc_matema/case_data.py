...
from appxc.setting import SettingDict, SettingSelect, SettingString
from appxc.storage import JsonSerializer, LocalStorage
...
class CaseData:
    ...
    #     appxc. THIS LEVEL IS NOT SUPPORTED. If this is required, scanner and
    ...
    def get_path_to_case_map(self) -> dict[str, str]:
        ...
        for case_path in self.case_data:
            path = self.get_case_path_string(case_path)
            case_name = self.get_case_name(case_path)
