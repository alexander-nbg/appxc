...
from appxc_matema.case_info import CaseInfo
from appxc_matema.case_parser import CaseParser
from appxc_matema.case_runner_gui import CaseRunnerGui
from appxc_matema.git_info import GitInfo
...
class ManualCaseRunner:
    ...
    def argparse_result(self):
        parser = argparse.ArgumentParser(
            prog=f"{sys.argv[0]}",
            description=(
                "This CaseRunner from APPXC MaTeMa "
