...
from appxc.storage import RamStorage, Storable, Storage

from .setting import AppxcSettingConversionError, AppxcSettingError, Setting


class AppxcSettingWarning(Warning):
    """Warning for AppxcSettings"""


class SettingDict(Setting[dict], Storable, MutableMapping[str, Setting]):
    """Maintain a dictionary of settings

    SettingDict maintains AppxcSettings for every dict entry such that
    setting_dict[key] = value may lead to AppxcSettingConversionError if the
    ...
    would accept an AppxcSetting to replace or add a new setting to a
    SettingDict.

    SettingDict is also implemented as an AppxcSetting. The value property
    ...
    def __init__(
        ...
        **kwargs,
        ...
        setting being an AppxcSetting object because this let's you apply
    ...
    def __setitem__(self, key, value) -> None:
        ...
        except (AppxcSettingError, AppxcSettingConversionError) as err:
            raise AppxcSettingError(
    ...
    def get_state(
        self,
        options: SettingDict.ExportOptions | None = None,
        **kwargs,
    ) -> object:
        ...
        for key, setting in self._value.items():
            ...
            elif list(this_data.keys()) == ["value"]:
    ...
    def set_state(
        ...
        **kwargs,
        ...
        if not isinstance(data, MutableMapping):
            raise AppxcSettingError("Input to set_state must be a dictionary.")
        ...
        if missing_keys:
            ...
            if not export_options.exception_on_missing_key:
                ...
                warnings.warn(AppxcSettingWarning(message), stacklevel=2)
            else:
                # exception expected:
                raise AppxcSettingError(message)
    ...
    def _validated_conversion(self, value: Any) -> tuple[bool, Any]:
        ...
        if not isinstance(value, Mapping):
            return False, AppxcSettingError(
