...
#    web research. By that base: it is not exactly APPXC.
...
# compatible to the compromise. This will imply that AppxcApplication does not
...
class AppxcApplication(tk.Tk):
    ...
    ``` from your_app import WelcomeFrame, ViewOneFrame from appxc.appframe
    ...
    def __init__(self, *args, **kwargs):
        """Create APPXC Application Window
