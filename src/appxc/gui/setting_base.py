...
"""Provide GUI classes for APPXC Setting objects."""

import tkinter as tk
from abc import ABC, abstractmethod

from appxc import logging
from appxc.setting import Setting, SettingBool
...
class SettingFrameDefault(SettingFrameBase):
    ...
    def __init__(self, parent, setting: Setting, **kwargs):
        ...
        self.place(
            ...
            row=0,
            column=1,
            setting=GridSetting(padx=x_padding, pady=5, sticky=entry_sticky),
        )
